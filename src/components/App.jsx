...
class App extends React.Component {
  ...
  onTouchPad(key) {
    let data = cfg[this.state.padKey].find(o => o.key === key);
  ...
  onPadPlay(event) {
    let data = cfg[this.state.padKey].find(o => o.key === event.target.id);
  ...
  render() {
    ...
    return (
        <div id="drum-machine">
          <h1 className='title'>FCC DRUM MACHINE</h1>
            <div id="keyboard">
                {cfg[padKey].map((o, i) => (<div className="drum-pad" id={o.pad} key={i} onClick={() => { this.onTouchPad(o.key) }}>
                ...
                <div id="controller">
                    <div className="custom-control custom-switch" id="control-power">
                        ...
                        <label htmlFor="power" className="custom-control-label">On-Off</label>
                    </div>
                    <div id="display"></div>
